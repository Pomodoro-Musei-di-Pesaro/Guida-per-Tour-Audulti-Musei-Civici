...
\begin{document}
	\begin{flushleft}
		...
		\begin{minipage}{\linewidth}
			\centering
			\zoombox{\includegraphics[]{Jacobello_Del_Fiore-Beata_Michelina_e_Santi.jpg}}
		...
		\begin{minipage}{\linewidth}
			\centering
			\zoombox{\includegraphics[]{Bellinzoni_Giovanni_Antonio_da_Pesaro-San_Terenzio.jpg}}
		...
		\begin{minipage}{\linewidth}
			\centering
			\zoombox{\includegraphics[]{Michele_di_Matteo-Sogno_della_Vergine.jpg}}
		...
		\begin{minipage}{\linewidth}
			\centering
			\zoombox{\includegraphics[]{Lanfranco_Girolamo_dalle_Gabicce-caccia_al_cinghiale_calidonio.jpg}}
		...
		\begin{minipage}{\linewidth}
			\centering
			\zoombox{\includegraphics[]{Ercole_e_Anteo_Caco_a_terra_senza_vita.jpg}}
		...
		\begin{minipage}{\linewidth}
			\centering
			\zoombox{\includegraphics[]{Faustina-Pittore_in_Casteldurante.jpg}}
			\captionof{figure}{Ercole e Anteo Caco a terra senza vita}
		\end{minipage}
		...
		\begin{minipage}{\linewidth}
			\centering
			\zoombox{\includegraphics[]{Pittore_del_Giudizio_di_Paride-san_Girolamo_penitente.jpg}}
